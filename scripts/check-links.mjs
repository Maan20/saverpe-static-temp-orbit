...
const valid = new Set([
  "/", "/solutions", "/industries", "/brands", "/why-orbit", "/api-integration", "/how-it-works", "/case-studies", "/about-us", "/faq", "/contact-sales", "/blog", "/privacy-policy", "/terms-of-service", "/glossary", "/editorial-policy", "/blog/rss.xml", "/llms.txt", "/llms-full.txt",
